...
/**
 * hlp_all - function prints all possible builtin shell_cmd commands.
 */
void hlp_all(void)
{
	...
	write(STDOUT_FILENO, outp, _strlen(outp));
	outp = "out more about the function 'name'.\n\n  alias   \t";
	write(STDOUT_FILENO, outp, _strlen(outp));
...
/**
 * hlp_alias - function prints information on the builtin shell_cmd command 'alias'.
 */
void hlp_alias(void)
{
	...
	write(STDOUT_FILENO, outp, _strlen(outp));
	outp = "is already an alias, replace its value with VALUE.\n";
	write(STDOUT_FILENO, outp, _strlen(outp));
}

/**
 * hlp_cd - function prints information on the builtin shell_cmd command 'cd'.
 */
void hlp_cd(void)
{
...
/**
 * hlp_exit - function prints information on the shell_cmd builtin command 'exit'.
 */
void hlp_exit(void)
{
...
void hlp_help(void)
{
	char *outp = "help: help\n\tSee all possible builtin shell_cmd commands.\n";

	write(STDOUT_FILENO, outp, _strlen(outp));
	outp = "\n      help [BUILTIN NAME]\n\tSee specific information on each ";
	write(STDOUT_FILENO, outp, _strlen(outp));
	outp = "builtin command.\n";
	write(STDOUT_FILENO, outp, _strlen(outp));
}
